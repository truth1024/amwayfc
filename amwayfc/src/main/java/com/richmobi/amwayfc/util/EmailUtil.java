...
public class EmailUtil {
	...
	private String mail_host = Configer.get("mail.smtp.host");
	private int mail_port = Configer.getInt("mail.smtp.port");
	private int encryptionType = EncryptionTypes.Default.ordinal();
	private boolean auth = false;
	private String mail_host_account = Configer.get("mail.smtp.user");
	private String mail_host_password = Configer.get("mail.smtp.password");
	private String senderAddress = Configer.get("mail.from");
	private String senderName = Configer.get("mail.name");
